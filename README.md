...
Usage will depend on the specific recording configuration. For mesoscopic closed-loop experiments, see: [Prof. Hyeyoung Shin's github](https://github.com/hs13/MesoHolo_OnlineAnalysis/tree/main)
